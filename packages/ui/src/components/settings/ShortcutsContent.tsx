/**
 * ShortcutsContent - Shortcuts settings content (reusable in SettingsPanel)
 *
 * This extracts the inner content from ShortcutsMenu to be used in the
 * tabbed SettingsPanel while keeping ShortcutsMenu working as a standalone modal.
 */
        ...
        {hasAnyCustomizations && (
          showResetConfirm ? (
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 rounded-lg flex items-center gap-1.5 flex-shrink-0"
            >
              <RotateCcw className="w-3.5 h-3.5" />
              Reset All
            </button>
