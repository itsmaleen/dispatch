...
export function ExecutionView({ taskId, onBack }: ExecutionViewProps) {
  return (
      ...
      <div className="h-12 flex-shrink-0 bg-zinc-900 border-b border-zinc-800 px-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <span className="text-sm text-zinc-500">
            Task: <span className="text-zinc-300">{taskId.slice(0, 8)}...</span>
          </span>
        </div>
        ...
        <PanelGroup direction="horizontal">
          ...
          <Panel defaultSize={40} minSize={20}>
            <PanelGroup direction="vertical">
              ...
              <Panel defaultSize={70} minSize={20}>
                <div className="h-full p-1">
                  <div className="h-full bg-zinc-900 border border-zinc-800 rounded-lg p-4">
